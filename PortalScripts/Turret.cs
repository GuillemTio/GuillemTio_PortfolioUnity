...
public class Turret : MonoBehaviour
{
    ...
    private void Start()
    {
        GameController.GetGameController().AddTurret(this);
    }
    ...
    private void Update()
    {
        ...
        bool l_Alive = l_DotAngle >= m_DotAlive;
        m_LineRenderer.gameObject.SetActive(l_Alive);
        if (l_Alive)
        {
